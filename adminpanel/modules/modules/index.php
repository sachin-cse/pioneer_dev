<div class="row page-titles">
    <div class="col-sm-5 align-self-center"><h3 class="text-primary"><?php echo ($data['parentModule']) ? $data['parentModule']['menu_name'] : 'Core Modules';?></h3></div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body text-right">
                    ...
                    <?php } ?>
                    <a href="<?php echo SITE_ADMIN_PATH;?>/index.php?pageType=<?php echo $this->_request['pageType'];?>&dtls=<?php echo $this->_request['dtls'];?>&dtaction=add<?php echo ($this->_request['parent_id'])? '&parent_id='.$this->_request['parent_id']:'';?>" class="btn btn-info">Add Module</a>
                </div>
            </div>
        </div>
    </div> */?>
                            ...
                            <div class="table-responsive">
                                ...
                                if($data['modules']) {
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                <?php /*<th width="40"><input type="checkbox" class="selectall" name="toggle"></th>*/?>
                                                <th width="60">Sl.</th>
                                                <th>Module</th>
                                                <th>Icon</th>
