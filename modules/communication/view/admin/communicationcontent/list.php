                        ...
                        <div class="form-inline">
                            ...
                            <div class="form-group">
                                <select name="searchPage" class="form-control">
                                    ...
                                    <?php
                                    foreach($data['linkedPages'] as $page) {
                                        if($this->session->read('searchPage') == $page['permalink'])
                                            echo '<option value="'.$page['permalink'].'" selected>'.$page['categoryName'].'</option>';
                                        else
                                            echo '<option value="'.$page['permalink'].'">'.$page['categoryName'].'</option>';
                                    }
                                    ?>
                                </select>
                            </div>
        ...
        <div class="col-sm-3">
            <div class="card">
                <div class="card-body text-center">
                    <a href="<?php echo SITE_ADMIN_PATH.'/index.php?pageType='.$this->_request['pageType'].'&dtls='.$this->_request['dtls'].'&dtaction=article&moduleId='.$this->_request['moduleId'];?>" class="btn btn-info">Add Content</a>
                </div>
            </div>
        </div>
                                    ...
                                    <tbody class="swap">
                                        ...
                                        foreach($data['contentList'] as $content) {
                                            ...
                                            <tr id="<?php echo 'recordsArray_'.$content['contentID'];?>">
                                                ...
                                                <td>
                                                    <a href="index.php?pageType=<?php echo $this->_request['pageType'];?>&dtls=<?php echo $this->_request['dtls'];?>&editid=<?php echo $content['contentID'];?>&moduleId=<?php echo $this->_request['moduleId'];?>">
                                                        <?php echo $content['contentHeading'];?>
                                                    </a>
                                                </td>

                                                <td>
                                                    <?php echo $content['categoryName'];?>
                                                </td>
