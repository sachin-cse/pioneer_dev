    ...
    <div class="row">
                                    ...
                                    <tbody class="swap">
                                        ...
                                        foreach($data['vendors'] as $item) {
                                            ...
                                            <tr id="<?php echo 'recordsArray_'.$item['vendorId'];?>">
                                                <td width="40">
                                                    <input type="checkbox" name="selectMulti[]" value="<?php echo $item['vendorId'];?>" class="case" />
                                                </td>
                                                <td colspan="2">
                                                    <a href="index.php?pageType=<?php echo $this->_request['pageType'];?>&dtls=<?php echo $this->_request['dtls'];?>&moduleId=<?php echo $this->_request['moduleId'];?>&editid=<?php echo $item['vendorId'];?>" data-vendorId="<?php echo $item['vendorId']; ?>">
        ...
        <div class="col-sm-3">
            <div class="card" style="padding: 0px !important;">
                <div class="card-header"><i class="fa fa-user-circle" aria-hidden="true"></i> <?php echo ($IdToEdit != '' ? 'Update Vendor <span class="pull-right"><a href="./index.php?pageType='.$this->_request['pageType'].'&dtls='.$this->_request['dtls'].'&moduleId='.$this->_request['moduleId'].'">Add Vendor</a></span>' : 'New Vendor');?></div>
                <div class="card-body">
                    <div class="col m-t-20 m-b-20">
                        <form name="modifycontent" action="" method="post" enctype="multipart/form-data" id="form">
                            <div class="form-group">
                                <label>Vendor Name *</label>
                                <input type="text" name="vendorName" value="<?php echo $vendorName;?>" class="form-control" placeholder="" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label>Contact Number *</label>
                                <input type="text" name="vendorPhone" value="<?php echo $vendorPhone;?>" class="form-control" placeholder="" autocomplete="off" maxlength="10">
                            </div>
                            <div class="form-group">
                                <label>Email Address</label>
                                <input type="text" name="vendorEmail" value="<?php echo $vendorEmail;?>" class="form-control" placeholder="" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label>Store Name *</label>
                                <input type="text" name="storeName" value="<?php echo $storeName;?>" class="form-control" placeholder="" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label>GST</label>
                                <input type="text" name="gst" value="<?php echo $gst;?>" class="form-control" placeholder="" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label>Address *</label>
                                <div class="limitedtext">
                                    <textarea name="vendorAddress" class="form-control" maxlength="80"><?php echo $vendorAddress;?></textarea>
